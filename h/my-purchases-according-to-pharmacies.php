...
<section class="content" id="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2><a href="" style="color: #00b6ca;">ofsahin.com</a> / My Purchases / By Pharmacies</h2>
        </div>
    </div>
                                                        ...
                                                        while ($i <= 10) {
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <form>
                                                                        <div class="demo-checkbox">
                                                                            <input type="checkbox" id="basic_checkbox_kare_kaud_<?php echo($i) ?>"/>
                                                                            <label for="basic_checkbox_kare_kaud_<?php echo($i) ?>"></label>
                                                                        </div>
                                                                    </form>
                                                                </td>
                                                        ...
                                                        while ($i <= 10) {
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <form>
                                                                        <div class="demo-checkbox">
                                                                            <input type="checkbox" id="basic_checkbox_not_deleivered_<?php echo($i) ?>"/>
                                                                            <label for="basic_checkbox_not_deleivered_<?php echo($i) ?>"></label>
                                                                        </div>
                                                                    </form>
                                                                </td>
